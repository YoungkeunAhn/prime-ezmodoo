...
function ContentHeader(props: Props) {
    ...
    return (
        <div className="grid grid-cols-8 text-[12px] border">
            ...
            <div className="h-[30px] p-2 border-b border-r text-center bg-[#F8F9FB] text-[#667084]">{managerName}</div>
            ...
            <div className="h-[30px] p-2 bg-[#0D3157] text-white col-span-7">
                <InputText type="text" className="w-full h-[18px] border-none outline-none text-white p-0 pl-2" value={productsName} name="productsName" style={{ background: 'none' }} onChange={onChange} />
            </div>
