...
function SearchIcon(props: IconProps) {
    ...
    return (
        <svg
            ...
            viewBox="0 0 479.8 479.7"
            enable-background="new 0 0 479.8 479.7"
            xmlSpace="preserve"
        >
            <path
                d="M193-188.4c-37.3,0-74.6,0-112,0c-13.5,0-23-5.9-27.5-17.5c-1.3-3.5-1.7-7.5-1.7-11.2c-0.1-43.8,0.2-87.6-0.2-131.5
	...
	C267.6-188.4,230.3-188.4,193-188.4z M244.2-285.7c0.2-26.1-24.9-52.5-58.7-47.9c-24.2,3.3-45.4,25.2-43.6,54.3
	c1.7,27.3,25.5,51.8,59.7,47.1C224.5-235.4,246.5-257,244.2-285.7z"
            />
            <path
                d="M508.1-564.4c0.1-1.8,0.3-3.1,0.3-4.4c0-14,0-27.9,0-42.9c-37,5.9-73.4,11.8-110.5,17.7c0,2.2,0,4.1,0,6.1
	...
	c-15.8-10.2-22.9-26-19.5-43.1c2.3-11.2,9.2-19.5,18.3-25.8c17.1-11.9,36.2-15,56.6-11.6C506.2-564.6,506.9-564.6,508.1-564.4z"
            />
            <path
                d="M177.3-660.3c5.9-5.5,11.4-11.5,17.8-16.5c23.5-18.6,59-21.2,84.8,1.3c26.9,23.4,29.7,62.2,12.7,89.3
	...
	C176.9-660.4,177.1-660.4,177.3-660.3z"
            />
            <path
                d="M483.5-345.5c6.3,0,11.8,0,17.3,0c12.7,0,25.3,0,38,0c2.2,0,4.3,0.1,6.5,0.2c7.7,0.3,12.4,9,7.9,15.5
	...
	C485.4-350.5,484.7-348.5,483.5-345.5z"
            />
            <image
                overflow="visible"
                width="628"
...
S/KbeUl+U28pL8ptcKSW8/8AGwNSn+LD2mfrXf8AFbJSUy3Rpx8bE5sf/if/AP/Z"
                transform="matrix(1 0 0 1 -8278 -8665.8242)"
            ></image>
            <g>
                <path
                    d="M-441.2-346.3c0-25.7,0.1-51.3-0.1-77c0-3.9,1.2-6.4,4.1-8.9c44.6-36.7,89.1-73.5,133.6-110.3
		...
		C-441.3-296-441.2-321.2-441.2-346.3z"
                />
                <path
                    d="M-134.1-608.9c0-23.6,0-46.1,0-68.6c0-11.2,3.4-14.6,14.6-14.7c16.5,0,33,0,49.5,0c10.4,0,14,3.7,14,14.2
		...
		c-8.6-10.2-16.9-20.6-25-31.1c-4.4-5.7-3-12,3.5-17.4c10.1-8.4,20.3-16.7,30.5-25.1C-428.6-561.8-357.7-620-287-678.3
		c16.9-13.9,35.3-19,55.3-8.5c9,4.7,16.6,12.1,24.6,18.6c23.1,18.8,46,37.8,69,56.7C-137.2-610.8-136-610.2-134.1-608.9z"
                />
            </g>
            <g>
                <path
                    d="M638.4-392.4c2.7,0,4.9,0,7,0c131,0,262,0,392.9,0c2.8,0,5.6,0.3,8.4,0.8c6.9,1.3,11.2,5.5,11.4,12.4
		...
		C638.4-397.5,638.4-395.2,638.4-392.4z"
                />
                <path
                    d="M969-572.5c0-34.7,0-69.3,0-104c0-11.5,4.5-15.9,16.1-15.9c9.5,0,19,0,28.5,0c9.8,0.1,14.7,4.9,14.7,14.7
		c0,70.1,0,140.3,0,210.4c0,9.8-5,14.6-14.8,14.6c-9.8,0-19.7,0-29.5,0c-10.1,0-15-4.8-15-14.9C969-502.5,969-537.5,969-572.5z"
                />
                <path
                    d="M789-557.5c0-29.7,0-59.3,0-89c0-11.5,4.5-15.9,16.1-15.9c9.5,0,19,0,28.5,0c9.8,0.1,14.7,4.9,14.7,14.7
		c0,60.1,0,120.3,0,180.4c0,9.8-5,14.6-14.8,14.6c-10,0-20,0.1-30,0c-9.5-0.1-14.5-4.9-14.5-14.4C789-497.2,789-527.4,789-557.5z"
                />
                <path
                    d="M879-527.3c0-19.8,0-39.6,0-59.5c0-10.9,4.6-15.6,15.4-15.6c9.7,0,19.3,0,29,0c9.9,0.1,14.9,4.8,14.9,14.5
		c0.1,40.3,0.1,80.6,0,120.9c0,9.2-5,14.2-14.2,14.3c-10.3,0.1-20.7,0.1-31,0c-9.1-0.1-14.1-5-14.2-14.3
		C879-487,879-507.2,879-527.3z"
                />
                <path
                    d="M758.4-497.3c0,10.2,0.1,20.3,0,30.5c-0.1,9.2-5,14.2-14.2,14.2c-10.3,0.1-20.6,0.1-31,0c-8.9-0.1-14.1-4.9-14.1-13.8
		c-0.1-20.8-0.1-41.6,0-62.4c0-8.3,5.1-13.4,13.4-13.5c10.8-0.2,21.6-0.2,32.5,0c8.3,0.1,13.2,5.2,13.4,13.5
		C758.5-518.3,758.4-507.8,758.4-497.3z"
                />
            </g>
            <g>
                <path
                    d="M-282.8,329.9c-78,0-156,0-234,0.1c-4.3,0-5.8-0.8-5.8-5.5c0.2-31.8,0.1-63.7,0.1-95.5c0-2.2,0-4.3,0.3-6.5
		c0.7-6,4.6-10.3,10.4-11.9c2.6-0.7,5.3-0.7,7.9-0.7c147.5,0,295,0,442.5,0c2.3,0,4.7,0,7,0.4c6.2,1,10.7,5.9,11.4,12.1
		c0.2,1.8,0.3,3.7,0.3,5.5c0,32.3-0.1,64.7,0.1,97c0,4.3-1.2,5.1-5.2,5.1C-126.2,329.9-204.5,329.9-282.8,329.9z M-462.7,284.9
		c8.7,0,15.1-6.3,15.1-15.1c0-8.6-6.2-14.8-14.7-14.9c-8.8-0.1-15.2,6-15.3,14.8C-477.7,278.5-471.4,284.9-462.7,284.9z
		 M-102.5,284.9c8.7,0,15-6.5,14.9-15.2c-0.1-8.5-6.3-14.7-14.8-14.8c-8.8,0-15.1,6.3-15.2,14.9C-117.6,278.6-111.2,285-102.5,284.9
		z"
                />
                <path
                    d="M-282.6,359.9c78.2,0,156.3,0,234.5-0.1c4.2,0,5.6,0.7,5.5,5.3c-0.2,32-0.4,64,0,96c0.2,14.6-7.5,18.9-19,18.9
		...
		c33.2,0,66.3,0,99.5,0C-373.3,359.9-327.9,359.9-282.6,359.9z M-462.8,434.9c8.7,0.1,15.1-6.2,15.1-15c0-8.5-6.1-14.9-14.5-15
		c-8.9-0.1-15.2,5.9-15.4,14.7C-477.7,428.4-471.5,434.8-462.8,434.9z M-102.5,434.9c8.7,0,15-6.5,14.9-15.2
		c-0.1-8.5-6.3-14.7-14.8-14.8c-8.8,0-15.1,6.3-15.2,14.9C-117.6,428.6-111.2,435-102.5,434.9z"
                />
                <path
                    d="M-372.8,179.9c-37.8,0-75.6-0.1-113.4,0.1c-3.6,0-4.6-0.8-5-4.5c-1.4-15.4-1-30.7,2.9-45.6c4.9-18.4,12.7-35.4,29.3-46.5
		c14.6-9.8,30.8-10.1,47.4-6.1c12.1,2.9,24,6.6,35,12.6c2.9,1.6,5.3,1.4,8.2-0.1c16.6-8.4,34-14.4,52.7-14.8
		c19.5-0.4,34.8,8.2,45.9,24.3c14.9,21.5,18.1,45.6,16,70.9c-0.8,9.6-1.2,9.6-11.1,9.6C-300.9,179.9-336.8,179.9-372.8,179.9z"
                />
                <path
                    d="M-249.4,76c18.7,0.9,35.8,5.3,51.8,13.5c3.5,1.8,6.4,2,10.1,0.1c16.2-8.4,33.4-14.1,51.8-14.5c19.9-0.4,35.4,8.4,46.2,25.3
		c13.8,21.5,17.8,45.1,15.7,70.1c-0.8,9.4-0.9,9.3-10.3,9.3c-45,0-89.9-0.1-134.9,0.1c-4.6,0-5.6-1.2-5.1-5.5
		c2-16.3,1.1-32.6-2.3-48.6C-230.2,107.9-237.2,91.2-249.4,76z"
                />
                <path
                    d="M-193,49c-0.1-11.7,2-22.8,9.6-32.2c7.6-9.5,18-13.7,29.5-15.8c5.7-1,11.6-1.2,17.4-1c1.6,0.1,2.9-0.1,3,2.2
		c0.7,14.8-0.3,29.3-9.9,41.6c-7,9-16.9,13.1-27.7,15.1c-5.6,1-11.2,1.1-16.9,1.2c-4.1,0.1-5.3-1.4-5.1-5.1C-192.9,53-193,51-193,49
		z"
                />
                <path
                    d="M-372.5,48.4c-0.4-15.5,4.3-28.9,17-38.5c9.8-7.4,21.3-9.7,33.2-9.9c9.9-0.2,10.1,0,9.8,9.9c-0.4,11.5-2.1,22.9-9.1,32.6
		c-7.1,10-17.7,14.2-29.2,16.3c-5.5,1.1-11.2,1.2-16.9,1.2c-3.2,0-4.6-0.8-4.4-4.1C-372,53.4-372.4,50.9-372.5,48.4z"
                />
            </g>
            <g>
                <path
                    d="M1437.8-452.6c49.3,0,98.6,0,148,0c15,0,26.8,8.7,30.6,22.3c1,3.4,1,6.9,1,10.4c0,57.8-0.3,115.6,0.2,173.4
		c0.2,22-16,34.1-34.2,34c-97.6-0.5-195.3-0.2-292.9-0.2c-16.1,0-27.3-7.9-31.8-22.1c-1.1-3.4-1.1-6.9-1.1-10.4
		c0-58,0.3-116-0.2-173.9c-0.2-21.4,15.9-34,33.9-33.7C1340.2-452.2,1389-452.6,1437.8-452.6z M1497.2-369.8c0,0-0.1,0-0.1,0
		...
		c-6.1,0-8.5,2.2-8.7,8.3C1497.1-379.5,1497.2-374.7,1497.2-369.8z"
                />
                <path
                    d="M1077.9-392.7c0-38.8,0.7-77.7-0.3-116.5c-0.5-22.1,17-34,33.6-33.6c27.1,0.7,54.3,0.1,81.5,0.3c4.2,0,5.3-1.1,5.3-5.3
		...
		c-1-3.3-0.7-6.6-0.7-9.9C1077.8-314.4,1077.9-353.6,1077.9-392.7z M1287-542.6c13.8,0,27.6-0.1,41.4,0.1c3.5,0,4.6-1,4.5-4.5
		c-0.2-17.6,0.1-35.3-0.1-52.9c-0.1-11.7-3.1-22.5-10.9-31.8c-13.2-15.6-35.3-20.2-52.9-11.9c-18.5,8.7-26.7,24.5-26.8,44.6
		c-0.1,17.1,0.1,34.3-0.1,51.4c0,3.8,0.9,5.2,5,5.1C1260.3-542.8,1273.6-542.6,1287-542.6z"
                />
            </g>
            <path
                d="M1927.5-330c-74,0-148,0-222,0c-19.6,0-34.2-8.2-43.4-25.6c-3.5-6.6-4.3-13.9-4.3-21.3c0-88.8,0.2-177.7-0.1-266.5
	...
	c0,88.3-0.1,176.7,0.1,265c0,19.8-8.1,34.6-25.8,43.7c-6.9,3.6-14.6,4.3-22.3,4.3C2075.5-330,2001.5-330,1927.5-330z M1928.1-450
	...
	c-0.4-4.9-3.6-7.3-8.1-8c-2.1-0.4-4.3-0.3-6.5-0.3C1997.7-450,1962.9-450,1928.1-450z M1747.8-630C1747.8-630,1747.8-630,1747.8-630
	...
	c6.8-0.1,9.9-2.8,10.4-9.5c1-13.6,1-27.3,0-40.9c-0.5-6.6-3.7-9.3-10.4-9.5C1760.5-630.1,1754.1-630,1747.8-630z M1837.8-630
	C1837.8-630,1837.8-630,1837.8-630c-6.3,0-12.6-0.2-19,0c-7.2,0.2-10.7,2.9-11.1,10c-0.7,13.4-0.9,26.9,0.1,40.4
	...
	C1850.5-630.1,1844.2-630,1837.8-630z M1927.6-570c6.3,0,12.6,0.1,19,0c7.1-0.2,10.2-2.8,10.7-9.8c0.9-13.4,0.9-26.9,0-40.4
	c-0.5-6.9-3.7-9.6-10.7-9.7c-12.6-0.2-25.3-0.2-37.9,0c-6.9,0.1-10.4,2.9-10.7,9.7c-0.8,13.4-0.9,26.9,0.1,40.4
	c0.5,7,3.6,9.5,10.7,9.8C1914.9-569.9,1921.3-570,1927.6-570z M2017.3-570.1C2017.3-570.1,2017.3-570,2017.3-570.1
	c6.3,0,12.6,0.1,19,0c7.4-0.2,10.6-2.7,11.1-10c0.9-13.3,0.9-26.6,0-39.9c-0.5-7.3-3.6-9.9-10.9-10c-12.5-0.2-25-0.2-37.4,0
	c-7.3,0.1-10.7,2.9-11.1,9.9c-0.7,13.4-0.9,26.9,0.1,40.4c0.5,6.8,3.5,9.3,10.4,9.5C2004.6-569.9,2010.9-570.1,2017.3-570.1z
	 M2107.6-630C2107.6-630,2107.6-630,2107.6-630c-6,0-12,0-18,0c-0.3,0-0.7,0-1,0c-7,0.3-10.4,2.9-10.8,9.7
	c-0.8,13.6-0.9,27.3,0.1,40.9c0.5,6.3,3.4,9.1,9.6,9.2c13.3,0.3,26.6,0.3,39.9,0c6.2-0.1,9.2-2.9,9.7-9.1
	c1.1-13.6,0.9-27.3,0.1-40.9c-0.4-7-3.6-9.6-10.6-9.8C2120.3-630.1,2114-630,2107.6-630z M1792.5-540c-6.3,0-12.6-0.1-19,0
	...
	c1-13.4,0.9-26.9,0.1-40.4c-0.4-7.5-3.7-10-11.4-10.1C1804.8-540.1,1798.6-540,1792.5-540z M1882.5-540
	C1882.5-540,1882.5-540,1882.5-540c-6,0-12,0-18,0c-0.3,0-0.7,0-1,0c-6.9,0.4-10.3,3-10.7,9.9c-0.7,13.4-0.9,26.9,0.1,40.4
	...
	C1894.8-540.1,1888.6-540,1882.5-540z M1972.3-480C1972.3-480,1972.3-480,1972.3-480c6.5,0,13,0.1,19.5-0.1
	...
	c-0.7,13.3-0.8,26.6,0.1,39.9c0.5,7.3,3.6,9.8,11,10C1960-479.9,1966.2-480,1972.3-480z M2062.3-480
	C2062.3-480,2062.3-480,2062.3-480c6.5,0,13,0.1,19.5-0.1c6.8-0.2,9.9-2.8,10.4-9.5c1-13.4,0.9-26.9,0.1-40.4
	...
	C2050-479.9,2056.2-480,2062.3-480z M1747.2-390.1c6.7,0,13.3,0.2,20-0.1c6.4-0.2,9.6-2.9,10-9.4c1-13.6,1-27.3,0-40.9
	c-0.5-6.7-3.6-9.5-10.3-9.6c-12.8-0.2-25.6-0.2-38.4,0c-6.9,0.1-10.3,3-10.6,9.9c-0.7,13.4-0.9,26.9,0.1,40.4
	c0.5,6.8,3.5,9.4,10.3,9.6C1734.5-389.9,1740.9-390.1,1747.2-390.1z M2107.3-390.1C2107.3-390,2107.3-390,2107.3-390.1
	...
	C2094.6-389.9,2101-390.1,2107.3-390.1z"
            />
            <g>
                <path
                    d="M2361.3-408.2l0.4-187.1h-57v-45.9c8.7,0,17.1-1.1,25.2-3.3c8.2-2.2,15.2-5.4,21-9.8c4.3-3.3,8.4-8,12.2-14.2
		c3.8-6.1,5.7-12.6,5.7-19.5h44.8v279.6H2361.3z"
                />
                <path
                    d="M2601.4-664.1c16.1,18.1,24.1,38.1,24.1,60.1c0,21.7-5.8,38.4-17.4,50.1c-11.6,11.7-23,21.8-34.2,30.2l-51.3,37.9
		...
		c16.1-20.5,39.5-30.8,70.4-30.8C2562.6-691.3,2585.3-682.2,2601.4-664.1z"
                />
                <path
                    d="M2830.3-528.9c8,11.6,12,24.3,12,38.1c0,23.7-9.2,44-27.5,60.8c-18.4,16.8-41.6,25.2-69.6,25.2c-27,0-50.2-8.6-69.6-25.8
		...
		c16.4,15.7,24.7,33.9,24.7,54.5c0,16.1-3.4,29-10.3,38.8c-6.9,9.8-14.2,16.8-21.8,20.8C2812.7-549.1,2822.3-540.5,2830.3-528.9z"
                />
            </g>
            <path
                d="M314.9,348.5c-54.1,40.8-113.6,50.8-177.3,32.9c-45.3-12.7-80.1-41.2-106.1-80C-19.6,224.9-7,119.4,58.1,55.5
	...
	c-2-1.5-3.8-3.2-5.6-5c-28.7-28.6-57.1-57.4-86-85.8c-7.8-7.6-12.2-15.9-11.1-26.9C315.2,354.7,314.9,352,314.9,348.5z M314.9,194.8
	c0.3-66.8-55.3-120.5-120.6-120.2c-65.7,0.3-119.8,55-119.6,120.3c0.2,67.1,56,120.2,120.5,120C260.4,314.7,315.3,260.6,314.9,194.8
	z"
            />
        </svg>
    )
